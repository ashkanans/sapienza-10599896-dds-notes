...
\begin{document}
	...
	\sectionCenteredfigure{\interfaceAPL}{Interface of Authenticated perfect point-to-poin links}{interface-of-authenticated-perfect-point-to-point-links}

	\subsubsection{Algorithms on Abstracting Links}	
	...
	\subsubsection{Failure Detection Abstraction}
	
	\subsubsection{Perfect Failure Detectors}
	
	\subsubsection{Eventually Perfect Failure Detectors}
