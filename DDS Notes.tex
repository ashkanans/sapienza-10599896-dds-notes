...
\begin{document}
	...
	\begin{center}
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.4\linewidth]{\dbstorageFiveTwelve}
		\end{figure}
		\vspace{1cm} 
		% TODO: Update version for each release
		{\fontsize{28}{34}\selectfont \textbf{Data Management}}
	\end{center}

	\vspace{1cm} 
	
	\begin{center}
	{\fontsize{22}{28}\selectfont \textbf{Professor: M. Lenzerini}}
	\end{center}
